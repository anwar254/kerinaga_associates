      ...
      <div class="columns">
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/DSCN8596.jpg" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
        ...
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/butterfly_apartments.gif" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
        ...
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/Parkands.jpg" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
      ...
      <div class="columns">
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/applecross.jpg" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
      ...
      <div class="columns">
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/splendor1.jpg" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
        ...
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/maringo_ech_home2.gif" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
      ...
      <div class="columns">
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/mt_view1.gif" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
        ...
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/prudential1.gif" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
      ...
      <div class="columns">
        ...
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/Irungu_2.jpg" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
        ...
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/oduol_2.jpg" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
      ...
      <div class="columns">
        ...
        <div class="column">
          <div class="k-tile">
            <div class="k-top">
              <div class="k-images">
                <img src="images\portfolio/sameer_bhatti.jpg" alt="portfolio">
              </div>
            </div>
            <div class="k-bottom">
              <div class="k-title">
